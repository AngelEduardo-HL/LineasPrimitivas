...
{
public:
    void FillDDA(const Geometry::Mat3& M, int X1, int Y1, int X2, int Y2, int X3, int Y3, Color col);
    void FillBRH(const Geometry::Mat3& M, int X1, int Y1, int X2, int Y2, int X3, int Y3, Color col);
